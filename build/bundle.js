...
/***/ function(module, exports, __webpack_require__) {
	...
	var Deck = __webpack_require__(8);
	...
	*/
	...
	Deck.prototype = {
	  init: function init() {
	    ...
	    for (var d = this.opts.decks; d >= 1; d--) this.createDeck();
	  ...
	  humanisedCardName: function humanisedCardName(faceValue, suite) {
	    var name = '';
	    switch (faceValue) {
	      case 0:
	        name = 'Ace';break;
	  ...
	  createDeck: function createDeck() {
	    for (var i = this.suites.length - 1; i >= 0; i--) {
	      ...
	      for (var n = faceValues.length - 1; n >= 0; n--) {
	        ...
	        if (n === 11 && this.opts.excludeKnights) addToStack = false;

	        if (addToStack) this.cards.push(card);
	      };
	    }
